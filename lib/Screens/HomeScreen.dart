...
//             // final userDetails = index < controller.details.length
...
//               onTap: () {
//                 print("Tapped on bill index: $index");
//                 print("Bills: ${controller.bills}");
//                 print("Details: ${controller.details}");
//                 print("Items: ${controller.items}");
//                 Get.to(() => ViewBills(
//                       bill: bill,
//                       userDetails: controller.details[index],
//                       // userDetails: index < controller.details.length
//                       //     ? controller.details[index]
//                       //     : {
//                       //         "per_name": "Unknown",
//                       //         "number": 0
